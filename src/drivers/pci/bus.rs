...
impl PciRoot {
    ...
    pub unsafe fn new(
        ...
        Self {
            ...
            dbi_addr,
            cam,
            atu: super::atu::DwPcieAtu::new(dbi_addr),
            cpu_addr,
            pci_addr,
            phy_start,
            pci_size,
    ...
    unsafe fn unsafe_clone(&self) -> Self {
        Self {
            ...
            dbi_addr: self.dbi_addr,
            cam: self.cam,
            atu: self.atu.clone(),
            cpu_addr: self.cpu_addr,
            pci_addr: self.pci_addr,
            phy_start: self.phy_start,
            pci_size: self.pci_size,
        }
    }
    ...
    pub(crate) fn config_read_word(
        ...
        self.atu
            .prog_outbound_atu(
                ...
                atu::AtuType::Config0,
                self.cpu_addr as u64,
                self.pci_addr as u64,
                self.pci_size as u32,
            )
            .unwrap();
