...
pub mod rtl8169 {
    ...
    pub const CPCMD_RXVLAN: u16 = 1 << 6; // RX VLAN De-tagging
    pub const CPCMD_RXCHKSUM: u16 = 1 << 5; // RX Checksum Offload
    pub const CPCMD_MULRW: u16 = 1 << 3; // PCI Multiple Read/Write Enable
    pub const CPCMD_CXPL: u16 = 1 << 0; // C+ mode enable
}
